...
</p> <div class="contact-actions" data-animate="reveal" data-astro-cid-j7pv25f6> <a href="mailto:" class="btn-primary" data-astro-cid-j7pv25f6>Say hello</a> <a${addAttribute(`${base}/contact`, "href")} class="btn-outline" data-astro-cid-j7pv25f6>All contact info</a> </div> </div> </section>  `, "footer": ($$result2) => renderTemplate`${renderComponent($$result2, "Footer", $$Footer, { "slot": "footer", "data-astro-cid-j7pv25f6": true })}`, "header": ($$result2) => renderTemplate`${renderComponent($$result2, "Header", $$Header, { "slot": "header", "data-astro-cid-j7pv25f6": true })}` })}  ${renderScript($$result, "/home/wing/src/pages/index.astro?astro&type=script&index=0&lang.ts")}`;
}, "/home/wing/src/pages/index.astro", void 0);
const $$file = "/home/wing/src/pages/index.astro";
const $$url = "/";
